                    ...
                    @if (Route::has('login'))
                        @auth
                            @if (Auth::user()->utype === 'ADM')
                                <li class="login-form"> <a href="#" title="myaccount">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                            ...
                            @elseif(Auth::user()->utype === 'SVP')
                                <li class="login-form"> <a href="#" title="myaccount">My Account (S Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                            ...
                            @else
                                <li class="login-form"> <a href="#" title="myaccount">My Account (Customer)</a>
                                    <ul class="drop-down one-column hover-fade">
